...
for n, i in enumerate(some_list[:]):
    if i.isdigit():
        ...
        some_list[some_list.index(i)] = ('0' + i if len(i) < 2 else i)  # Уверен, что не правильно сделал.
    elif not i.isalpha():
        some_list.insert(some_list.index(i), '"')
        some_list.insert(some_list.index(i) + 1, '"')
...
print(f'{some_list[0]} {some_list[1]}{some_list[2]}{some_list[3]} {some_list[4]}'
      ...
      f' {some_list[10]} {some_list[11]} {some_list[12]}{some_list[13]}{some_list[14]} {some_list[15]}')
...
price_list = [round(random.uniform(1.0, 25.0), 2) for i in range(10, 20)]

print(price_list)

for i in price_list[:]:
    splt_price = i.__str__().split('.')
